...
const Programs = () => {
    ...
    return (
        <div className='text-center w-11/12 mx-auto mt-28'>
            ...
            <p className='w-9/12 m-auto'>Explore our Programs section for comprehensive and specialized music learning experiences. Discover structured curricula tailored to your goals, whether it's instrument mastery, music theory, composition, or performance. Join us for a focused and transformative musical journey.</p>
