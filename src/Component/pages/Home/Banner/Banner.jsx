...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    <img src={img1} className="w-full lg:h-[750px]" />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide3" className="btn btn-circle text-white bg-gray-400 bg-opacity-50 border-white">❮</a> 
      <a href="#slide2" className="btn btn-circle text-white bg-gray-400 bg-opacity-50 border-white">❯</a>
    </div>
  </div> 
  <div id="slide2" className="carousel-item relative w-full">
    <img src={img2} className="w-full lg:h-[750px]" />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide1" className="btn  btn-circle text-white bg-gray-400 bg-opacity-50 border-white">❮</a> 
      <a href="#slide3" className="btn btn-circle text-white bg-gray-400 bg-opacity-50 border-white">❯</a>
    </div>
  </div> 
  <div id="slide3" className="carousel-item relative w-full">
    <img src={img3} className="w-full lg:h-[750px]" />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide2" className="btn btn-circle text-white bg-gray-400 bg-opacity-50 border-white">❮</a> 
      <a href="#slide1" className="btn btn-circle text-white bg-gray-400 bg-opacity-50 border-white">❯</a>
    </div>
  ...
  <div id="slide4" className="carousel-item relative w-full">
    ...
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      ...
      <a href="#slide1" className="btn btn-circle text-white bg-gray-400 bg-opacity-50 border-white">❯</a>
            ...
            <div className='bg-pink-600 flex gap-8 lg:w-2/5 p-6 mx-4 lg:mx-0 rounded-xl absolute lg:right-20 top-[200px] lg:top-[680px] border-white border-4'>
            <div>
