...
const AllUsers = () => {
  ...
  const { data: users = [], refetch } = useQuery(["allUsers"], async () => {
    const res = await fetch(
      "https://audiopair-server-main.vercel.app/allUsers",
      {
        headers: {
  ...
  const handleAdmin = (user) => {
    fetch(`https://audiopair-server-main.vercel.app/users/admin/${user._id}`, {
      method: "PATCH",
      headers: {
        authorization: `bearer ${token}`,
      },
  ...
  const handleInstructor = (user) => {
    fetch(
      `https://audiopair-server-main.vercel.app/users/instructors/${user._id}`,
      {
        method: "PATCH",
        headers: {
          authorization: `bearer ${token}`,
  ...
  const handleStudent = (user) => {
    fetch(
      `https://audiopair-server-main.vercel.app/users/students/${user._id}`,
      {
        method: "PATCH",
        headers: {
          authorization: `bearer ${token}`,
