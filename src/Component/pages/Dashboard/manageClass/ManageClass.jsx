...
const ManageClass = () => {
  ...
  const { data: classesData = [], refetch } = useQuery(
    ...
    async () => {
      const res = await fetch(
        "https://audiopair-server-main.vercel.app/classes",
        {
          headers: {
  ...
  const handleApprove = (item) => {
    fetch(
      `https://audiopair-server-main.vercel.app/classes/approve/${item._id}`,
      {
        method: "PATCH",
      }
    )
  ...
  const handleDelete = (item) => {
    fetch(
      `https://audiopair-server-main.vercel.app/classes/denied/${item._id}`,
      {
        method: "PATCH",
      }
    )
