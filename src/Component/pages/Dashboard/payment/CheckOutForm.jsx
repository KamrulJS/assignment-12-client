...
const CheckOutForm = ({ price, selectedClasses }) => {
        ...
        if (res.data.insertResult.insertedId) {
          ...
          });
          {
            selectedClasses?.map((cls) => {
              ...
              fetch(
                `https://audiopair-server-main.vercel.app/classes/enrolled/${cls.courseId}`,
                {
                  method: "PATCH",
                  headers: {
                ...
                .then((data) => {
                  if (data.modifiedCount > 0) {
                    ...
                    fetch(
                      "https://audiopair-server-main.vercel.app/classes/enrolled",
                      {
                        method: "POST",
                        headers: {
                          "content-type": "application/json",
  ...
  return (
    <>
      <form
        className="m-8 w-4/5 bg-slate-200 p-4 rounded-xl mx-auto"
